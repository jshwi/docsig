...
.. |VS Code Build| image:: https://github.com/jshwi/docsig/actions/workflows/build-vscode-extension.yaml/badge.svg
   ...
   :alt: Build
.. |VS Code Extension| image:: https://img.shields.io/badge/vscode%20extension-v1.1.0-007ACC
...
.. code-block:: console
    ...
    $ flake8 --version
    7.3.0 (docsig: 0.96.0, mccabe: 0.7.0, pycodestyle: 2.14.0, pyflakes: 3.4.0) CPython 3.10.19 on Darwin
