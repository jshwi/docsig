...
@extension
def generate_pyproject_toml_schema_info() -> None:
    ...
    (GENERATED / "pyproject-schema-info.rst").write_text(
...
def setup(app: Sphinx) -> None:
    ...
    app.connect("builder-inited", generate_pyproject_toml_schema_info)
