...
- short form for include-ignored ([#1048](https://github.com/jshwi/docsig/issues/1048))

## [0.94.0](https://github.com/jshwi/docsig/tree/v0.94.0) - 2026-08-08

### Removed

- ignore-typechecker option ([#1041](https://github.com/jshwi/docsig/issues/1041))
...
- short form for check-overridden ([#945](https://github.com/jshwi/docsig/issues/945))
...
- short form for check-class-constructor ([#834](https://github.com/jshwi/docsig/issues/834))
...
- short form for check-protected-class-methods ([#823](https://github.com/jshwi/docsig/issues/823))
...
- false positive Google style SIG506 ([#781](https://github.com/jshwi/docsig/issues/781))
...
- future description-missing-period warning ([#758](https://github.com/jshwi/docsig/issues/758))
...
- short form for ignore-kwargs ([#722](https://github.com/jshwi/docsig/issues/722))

## [0.77.0](https://github.com/jshwi/docsig/tree/v0.77.0) - 2026-01-31

### Removed

- short form for ignore-typechecker ([#719](https://github.com/jshwi/docsig/issues/719))
...
- incorrect params-out-of-order ([#701](https://github.com/jshwi/docsig/issues/701))

## [0.74.0](https://github.com/jshwi/docsig/tree/v0.74.0) - 2026-01-05

### Changed

- enforce capitalization by default ([#693](https://github.com/jshwi/docsig/issues/693))

### Deprecated

- enforce-capitalization option ([#695](https://github.com/jshwi/docsig/issues/695))
