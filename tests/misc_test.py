...
def test_print_version(
    ...
    """Test printing of a version on the commandline.
...
def test_lineno(
    ...
    """Test printing of three function errors with a line number.
...
def test_file_not_found_error(main: MockMainType) -> None:
    """Test FileNotFoundError for an incorrect path arg.
...
def test_str_path_via_api() -> None:
    ...
    No need to make any assertions, only need to avoid the following:
...
def test_bad_py_file(
    ...
    """Test invalid syntax on a '.py' file.
