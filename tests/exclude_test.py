...
def test_exclude_defaults(
    ...
    expected = [
        ...
        f"{Path('whitelist.py')}: parsed valid code",
        f"{Path('.pre-commit-hooks.yaml')}: Parsing Python code failed",
        f"{Path('pyproject.toml')}: parsed valid code",
        f"{Path('.bumpversion.cfg')}: Parsing Python code failed",
        f"{Path('node_modules')}: in exclude list, skipping",
        f"{Path('tests/misc_test.py')}: parsed valid code",
        f"{Path('tests/conftest.py')}: parsed valid code",
        f"{Path('tests/disable_test.py')}: parsed valid code",
        f"{Path('tests/__init__.py')}: parsed valid code",
        f"{Path('tests/__pycache__')}: in exclude list, skipping",
        f"{Path('tests/TESTS.md')}: Parsing Python code failed",
        f"{Path('tests/git_test.py')}: parsed valid code",
        f"{Path('tests/_test.py')}: parsed valid code",
        ...
        f"{Path('docs/conf.py')}: parsed valid code",
        ...
        f"{Path('docsig/_stub.py')}: parsed valid code",
        f"{Path('docsig/_report.py')}: parsed valid code",
        f"{Path('docsig/_main.py')}: parsed valid code",
        f"{Path('docsig/_version.py')}: parsed valid code",
        f"{Path('docsig/_module.py')}: parsed valid code",
        f"{Path('docsig/__init__.py')}: parsed valid code",
        f"{Path('docsig/_display.py')}: parsed valid code",
        f"{Path('docsig/_hooks.py')}: parsed valid code",
        f"{Path('docsig/__pycache__')}: in exclude list, skipping",
        f"{Path('docsig/_message.py')}: parsed valid code",
        f"{Path('docsig/_core.py')}: parsed valid code",
        f"{Path('docsig/_decorators.py')}: parsed valid code",
        f"{Path('docsig/messages.py')}: parsed valid code",
        f"{Path('docsig/py.typed')}: Parsing Python code failed",
        f"{Path('docsig/_config.py')}: parsed valid code",
        f"{Path('docsig/__main__.py')}: parsed valid code",
        f"{Path('docsig/_utils.py')}: parsed valid code",
        f"{Path('docsig/_directives.py')}: parsed valid code",
