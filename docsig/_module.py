...
class Parent:  # pylint: disable=too-many-instance-attributes
    ...
    def _parse_ast(
        ...
        # resolved in 'directives' object, they are needed to notify the
        # user in the case that they are invalid
    ...
    def isprotected(self) -> bool:
        """Boolean value for whether a class is protected."""
...
class Function(Parent):
    ...
    def __len__(self) -> int:
        """Length of the longest args sequence."""
    ...
    def ismethod(self) -> bool:
        """Boolean value for whether a function is a method."""
        return isinstance(self._parent, _ast.ClassDef)

    @property
    def isproperty(self) -> bool:
        """Boolean value for whether a function is a property."""
        valid_properties = [
            "property",
            "cached_property",
        ]
    ...
    def isinit(self) -> bool:
        """Boolean for whether a function is a class constructor."""
        return self.ismethod and self.name == "__init__"

    @property
    def isoverridden(self) -> bool:
        """Boolean value for whether a function is overridden."""
    ...
    def overload(self, rettype: _RetType) -> None:
        ...
        :param rettype: Return the type of overloaded signature.
        """
